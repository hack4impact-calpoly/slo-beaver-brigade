...
export default function Page() {
  ...
  const [isPrivateEvent, setIsPrivateEvent] = useState<boolean>(false); // adding private event const
        ...
        <VStack spacing={4} align="stretch" flex="1">
          ...
          <Flex direction={{ base: "column", md: "row" }} gap={20} mb={6}>
            <VStack spacing={4} align="stretch" flex="1">
              ...
              <HStack justifyContent="space-between">
                <FormControl width="48%">
                  <FormLabel htmlFor="private-event" fontWeight="bold">
                    Private Events
                  </FormLabel>
                  <div className="flex sm:flex-row flex-col-reverse gap-5 sm:gap-10 sm:items-center">
                    <div className="flex flex-row gap-4 justify-center">
                      ...
                      <Checkbox
                        ...
                        onChange={() => setIsPrivateEvent((prev) => !prev)}
                      />
                    </div>
                  </div>
                </FormControl>

                {isPrivateEvent && groups && (
                  <div className="flex sm:flex-row flex-col-reverse gap-5 sm:gap-10 sm:items-center">
                    ...
                    <div className="flex flex-row gap-4 justify-center">
                      ...
                      <Checkbox
                        ...
                        onChange={() =>
                          setSendEmailInvitees((checked) => !checked)
                        }
                      />
                    </div>
                  </div>
          ...
          {/* <div className="text-xl font-bold mb-4">Private Events</div>
