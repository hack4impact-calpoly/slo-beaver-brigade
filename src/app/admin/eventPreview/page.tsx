...
import style from "@styles/admin/events.module.css"; // Ensure this path matches your CSS module path
import EventPreviewComponent from "@components/EventPreview";

// Assuming this interface reflects your event model
interface IEvent {
  _id: string;
  eventName: string;
  location: string;
...
const EventPreview = () => {
  ...
  const fetchEvents = async () => {
    try {
      ...
      setEvents(data.map((event: IEvent) => ({
        ...event,
